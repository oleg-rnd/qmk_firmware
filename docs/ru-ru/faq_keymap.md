...
Касается личной "проблемы" автора этих строк. Он часто ошибочно набирал «the» или «THe» вместо «The». One Shot Shift частично решает этот впрос <https://github.com/tmk/tmk_keyboard/issues/67>
...
Смотрите [функциии связанные с Unicode](https://docs.qmk.fm/#/feature_unicode)
